...
const ProductsMenu = ({ dropName }) => {
    ...
    // Guard: check productData is an array before filter
        ...
        <div style={{ marginLeft: "2rem" }}>
            ...
            >
                {uniqueItems.map(data => (
                    <MenuItem
                        onClick={() => {
                            catHandler(dropName === "Categories" ? data.category : data.subcategory);
                        }}
                        key={data._id || (dropName === "Categories" ? data.category : data.subcategory)}
                    >
